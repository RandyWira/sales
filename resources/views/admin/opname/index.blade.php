        ...
        <div class="container-fluid dashboard-content">
            ...
            <script>
                ...
                $('#tambah-input').click(function() {
                    ...
                    list.append(
                        " <tr class='baris-data'>\
                                                                                                                <td><input type='number' placeholder='Stok Real' class='span1 real_stok' name='angka[" +
                        angka +
                        "][real]' readonly='true'></td> \
                                                                                                                <td width='20%'><input name='angka[" +
                        angka +
                        "][nama]' type='text' autocomplete='off' list='list-data' class='typeahead span1 caribarang' placeholder='Nama Obat'> </td>\
                                                                                                                <td width='5%'>\
                                                                                                                ...
                                                                                                                <input type='hidden' placeholder='ID Obat' class='span1 id-barang' name='angka[" +
                        angka +
                        "][id]'> </td>\
                                                                                                                <td><input type='number' placeholder='Harga Beli' class='span1 harga-beli' name='angka[" +
                        angka +
                        "][harga_beli]'></td> \
                                                                                                                <td><input type='number' placeholder='Stok' class='span1 stok' name='angka[" +
                        angka +
                        "][stok]'></td> \
                                                                                                                <td><input type='text' class='span1 harga-selisih' name='angka[" +
                        angka +
                        "][selisih]' placeholder='Selisih'></td> \
                                                                                                                <td><input type='text' class='span1 harga-lebih' name='angka[" +
                        angka +
                        "][lebih]' placeholder='Lebih'></td> \
                                                                                                                <td><input type='text' class='span1 nominal-selisih' name='angka[" +
                        angka +
                        "][nominal_selisih]' placeholder='nominal_selisih'></td> \
                                                                                                                <td><input type='text' class='span1 nominal-lebih' name='angka[" +
                        angka + "][nominal_lebih]' placeholder='nominal_lebih'></td> \
