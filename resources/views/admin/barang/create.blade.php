                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3"><span class="input-group-prepend"><span
                                                ...
                                                <input type="number" class="form-control" id="harga_eceran"
                                                    name="harga_eceran" placeholder="Harga Jual Eceran" required>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group mb-3"><span class="input-group-prepend"><span
                                                            class="input-group-text">Rp</span></span>
                                                    <input type="number" class="form-control" id="harga_grosir"
                                                        name="harga_grosir" placeholder="Harga Jual Grosir" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
