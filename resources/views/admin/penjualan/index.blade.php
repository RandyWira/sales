...
@section('content')
                                ...
                                <table class="table bordered-table" style="width:100%">
                                    ...
                                    <tbody id="list-form">
                                        <tr class="baris-data">
                                            ...
                                            <td>
                                                <input type="number" name="jual[0][harga_grosir]"
                                                    class="form-control harga_grosir" placeholder="Harga Grosir">
                                            </td>
                                            <td style="width: 8%">
                                            ...
                                            <td>
                                                <input type="satuan" name="jual[0][satuan]" class="form-control satuan"
    ...
    <script>
        ...
        $('#tambah-input').click(function() {
            ...
            list.append(
                '<tr class="baris-data"> \
                        <td style="width: 7%"><input type="text" placeholder="Kode Barang" class="form-control id-barang" name="jual[' +
                jual + '][id]" readonly></td> \
                        ...
                        <td><input type="number" name="jual[' + jual + '][harga_grosir]" class="form-control harga_grosir" placeholder="Harga Grosir"></td> \
            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function(index, obj) {
                        ...
                        baris_b.find('.harga_grosir').val(obj.harga_grosir)
        ...
        $(document).on('change', '.qty', function() {
            ...
            var harga_grosir = baris_barang.find('.harga_grosir');
            ...
            subtotal.val(parseInt(qty) * parseInt(harga_grosir.val()))
            mencari_total()
        })
